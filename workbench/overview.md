---
title: Kompo Workbench
description: Visualisez et explorez votre architecture Kompo
---


# Kompo Workbench - Visualisez votre Architecture

Kompo Workbench est l'outil visuel qui vous permet de comprendre, explorer et maintenir votre architecture hexagonale en temps réel.

## Qu'est-ce que Kompo Workbench ?

Kompo Workbench est une interface web qui :
...
::: tip
Kompo Workbench est inclus dans chaque projet Kompo. Lancez-le avec `pnpm workbench`.
:::
...
Kompo Workbench génère automatiquement :
...
Kompo Workbench est extensible avec des plugins :
...
- name: Generate Architecture Docs
  run: |
    pnpm workbench screenshot --output docs/architecture.png
    pnpm workbench export --format markdown --output docs/api.md
...
```typescript
// Configurez les alerts dans Workbench
{
  alerts: {
    'high-latency': {
      threshold: 500, // ms
...
Kompo Workbench transforme votre architecture complexe en une visualisation claire et maintenable. Essayez-le dès maintenant !
